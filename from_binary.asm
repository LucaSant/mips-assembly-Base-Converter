...
#começo da função que converte binário para decimal e da função que converte binário para hexadecimal
#Parâmetros
...
loop_one:
	beq $t4, 32, end_loop_one		#se o contador $t4 chegar em 32, que é o tamanho máximo de digitos suportado em binário, a entrada é invalida 
...
invalid:
	...
	#volta para o número funão que lê o número em binário
	j num_bin 
...
end_loop_one: # Fim bin_to_dec
	...
	beq $t9, 10, print_output_dec 		#verifica se a base de saída é realmente decimal
...
bin_to_hexa:
	...
	j dec_to_hexa						# processamento vai para 'dec_to_hexa', para converter decimal para hexadecimal 
									#de lá  retornará para a arquivo main na função 'print_output_bin_hexa'
